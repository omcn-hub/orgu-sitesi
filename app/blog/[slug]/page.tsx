        ...
        <div className="relative h-[65vh] lg:h-[75vh] bg-stone-900">
          ...
          <div className="absolute inset-0 z-20 flex items-end justify-center px-6 pb-12">
            <div className="max-w-4xl mx-auto text-center">
              <time className="text-warm-gold text-sm lg:text-base font-semibold tracking-widest mb-4 block uppercase drop-shadow-sm">
                {post.date}
              </time>
              <h1 className="font-heading text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold !text-white mb-4 tracking-tight leading-tight drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
                {post.title}
              </h1>
              <p className="!text-white/95 text-base lg:text-lg max-w-2xl mx-auto drop-shadow-sm font-medium">
                {post.description}
              </p>
            </div>
          </div>
